...
import 'package:dashboard/features/dashboard/presentation/widgets/constant/each_region_box.dart';
...
class _IfHaveDataState extends State<IfHaveData> {
  ...
  Widget build(BuildContext context) {
    ...
    print("aman ${FilterListAccouringToItRegion("EU")}");
    return Padding(
          ...
          child: Center(
            ...
            children: [
              ...
              EachRegionBox(
                ...
                filteredList: FilterListAccouringToItRegion("DE"),
                defultList: FilterListAccouringToItRegion("DE"),
              ),
              ...
              EachRegionBox(
                ...
                filteredList: FilterListAccouringToItRegion("EU"),
                defultList: FilterListAccouringToItRegion("EU"),
              ),
              // eachRegionBox(
              ...
              EachRegionBox(
                ...
                filteredList: FilterListAccouringToItRegion("US"),
                defultList: FilterListAccouringToItRegion("US"),
              ),
            ],
          )),
        ),
                ...
                filteredList!.isNotEmpty
                    ? Expanded(
                        ...
                        itemBuilder: (context, index) {
                          print("filteredList listview ${searchList}");
                          return Padding(
                              padding: const EdgeInsets.all(8.0),
                              child: Material(
                                borderRadius:
